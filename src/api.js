...
export async function getNewsByKeyword(keyword) {
    ...
    const news = await axios.get(
        `http://api.mediastack.com/v1/news?access_key=66261eeb5a38273918edbbbe0eb287a1&keywords=${keyword}&sources=en,-de&sort=popularity&limit=15&sources=cnn,-bbc`
    );
...
export async function getRandomNews() {
    ...
    const news = await axios.get(
        `http://api.mediastack.com/v1/news?access_key=66261eeb5a38273918edbbbe0eb287a1&sources=en,-de&sort=popularity&limit=15&sources=cnn,-bbc`
    );
    return news.data.data
}
...
export async function getNewsByKeywordAndFilter(keyword, filter) {
    ...
    let baseUrl = 'http://api.mediastack.com/v1/news?access_key=66261eeb5a38273918edbbbe0eb287a1&sort=popularity&limit=15'
    if (keyword) {
